...
variable is set to 'TRUE', showing the code but loading results. Change to 
...
```{r, tableStationaryRegion, fig.cap='(Table 3.1) Empiracal rejection frequencies under the null.'}
